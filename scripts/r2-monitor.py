...
def main():
    ...
    try:
        ...
        # Keep the last valid listing during transient network timeouts;
        # exposing the transport error makes the dashboard look broken even
        # though upload and cached data remain healthy.
        r2_error = None
