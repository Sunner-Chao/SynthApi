            ...
            {props.trend && (
              <span
                className={cn(
                  ...
                  props.trend.value > 0 && 'bg-success/10 text-success',
                  props.trend.value < 0 && 'bg-destructive/10 text-destructive',
                  props.trend.value === 0 && 'bg-muted text-muted-foreground'
                )}
              >
                {props.trend.value > 0 ? (
