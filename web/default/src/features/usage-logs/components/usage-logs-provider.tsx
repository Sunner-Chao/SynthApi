...
import type { ChannelAffinityInfo, UsageLogRewardSummaries } from '../types'
...
interface UsageLogsContextValue {
  ...
  rewardSummaries: UsageLogRewardSummaries
  setRewardSummaries: (summaries: UsageLogRewardSummaries) => void
}
...
export function UsageLogsProvider({ children }: { children: ReactNode }) {
  ...
  const [rewardSummaries, setRewardSummaries] =
    useState<UsageLogRewardSummaries>({})
