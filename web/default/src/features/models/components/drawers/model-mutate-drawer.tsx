                          ...
                          <FormItem>
                            ...
                            <FormDescription>
                              {field.value && !isNaN(parseFloat(field.value))
                                ? `${t('Calculated price')}: ${formatBillingCurrencyFromUSD(parseFloat(field.value) * 2)} ${t('per 1M tokens')}`
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              ...
                              promptPrice &&
                              !isNaN(parseFloat(promptPrice))
                                ? `${t('Calculated price')}: ${formatBillingCurrencyFromUSD(parseFloat(promptPrice) * parseFloat(field.value))} ${t('per 1M tokens')}`
                    ...
                    <>
                      <div className='space-y-4'>
                        <div className='space-y-2'>
                          <Label>{t('Prompt price (per 1M tokens)')}</Label>
                          <Input
                            type='text'
                            placeholder='2.0'
                            value={promptPrice}
                        ...
                        <div className='space-y-2'>
                          <Label>{t('Completion price (per 1M tokens)')}</Label>
                          <Input
                            type='text'
                            placeholder='4.0'
