    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          AlipayPlatformPublicKey: settings.AlipayPlatformPublicKey ?? '',
          ...
          XPayEnabled: settings.XPayEnabled ?? false,
          XPayApiBase: settings.XPayApiBase ?? '',
          XPayAppID: settings.XPayAppID ?? '',
          XPayAppSecret: settings.XPayAppSecret ?? '',
          XPayPaymentType: settings.XPayPaymentType ?? 'DMF',
          XPayReturnURL: settings.XPayReturnURL ?? '',
          XPayNotifyURL: settings.XPayNotifyURL ?? '',
          XPayUnitPrice: settings.XPayUnitPrice ?? 7.3,
          XPayMinTopUp: settings.XPayMinTopUp ?? 1,
          XPayGatewayPath: settings.XPayGatewayPath ?? '/alipay/precreate',
          XPayNotifySuccess: settings.XPayNotifySuccess ?? 'OK',
          MPayEnabled: settings.MPayEnabled ?? false,
          MPayApiBase: settings.MPayApiBase ?? '',
          MPayPid: settings.MPayPid ?? '',
          MPayKey: settings.MPayKey ?? '',
          MPayPaymentType: settings.MPayPaymentType ?? 'alipay',
          MPayReturnURL: settings.MPayReturnURL ?? '',
          MPayNotifyURL: settings.MPayNotifyURL ?? '',
          MPayUnitPrice: settings.MPayUnitPrice ?? 7.3,
          MPayMinTopUp: settings.MPayMinTopUp ?? 0.1,
          MPayNotifySuccess: settings.MPayNotifySuccess ?? 'success',
        }}
        waffoDefaultValues={{
