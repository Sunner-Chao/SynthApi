...
const defaultSecuritySettings: SecuritySettings = {
  ...
  SensitiveNotifyAdminEmailEnabled: false,
  SensitiveNotifyUserEmailEnabled: false,
  SensitiveRiskScanEnabled: true,
  SensitiveRiskThreshold: 100,
  SensitiveWords: '',
  SensitiveIntentRules: '',
  SensitiveRegexRules: '',
  SensitiveRiskAllowRules: '',
