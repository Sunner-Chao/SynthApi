...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.ModelTextRequestBodyGuard())
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	relayV1Router.Use(middleware.PromptCacheKeyConcurrencyLimit())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.ModelRequestConcurrencyLimit(), middleware.Distribute())
	{
...
func registerAnthropicAliasRouter(group *gin.RouterGroup) {
	...
	group.Use(middleware.ModelRequestConcurrencyLimit())
	group.Use(middleware.ModelTextRequestBodyGuard())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.ModelRequestConcurrencyLimit(), middleware.Distribute())
	{
