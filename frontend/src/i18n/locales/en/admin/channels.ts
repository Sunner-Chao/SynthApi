export default {
    ...
    channelMonitor: {
      ...
      connectivityOnlyBadge: 'Connectivity only',
      ...
      form: {
        ...
        probeModeModelRequest: 'Model request',
        probeModeModelRequestHint: 'Send an authenticated lightweight challenge to verify the model itself.',
        probeModeConnectivityOnly: 'Connectivity only',
        probeModeConnectivityOnlyHint: 'Send a credential-free HEAD request to the upstream origin without calling a model API.',
