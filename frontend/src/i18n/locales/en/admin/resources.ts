export default {
    ...
    redeem: {
      ...
      consignment: {
        settingsButton: 'Consignment',
        title: 'Consignment recharge',
        description: 'Upload generated redeem codes as card inventory to a third-party store. Buyers return to SynthAPI to redeem them.',
        enable: 'Show purchase link to users',
        enableHint: 'When enabled, the user redeem page shows a purchase button.',
        purchaseUrl: 'Purchase product URL',
        purchaseUrlHint: 'Use a product URL such as https://pay.ldxp.cn/item/xxxxxx, or a shop URL.',
        workflowTitle: 'Recommended workflow',
        workflowGenerate: 'Generate codes for the plan and download the TXT file.',
        workflowUpload: 'Upload the TXT contents to the product card inventory.',
        workflowRedeem: 'After payment, the buyer enters the delivered code in SynthAPI.',
        openLdxp: 'Open LDXP merchant portal',
        openCatfk: 'Open CatFK merchant portal',
        uploadToLdxp: 'Open LDXP',
        uploadToCatfk: 'Open CatFK',
        loadFailed: 'Failed to load consignment settings',
        urlRequired: 'A purchase URL is required when the purchase link is enabled',
        saved: 'Consignment settings saved',
        saveFailed: 'Failed to save consignment settings'
      },
      codeType: 'Code Type',
      amount: 'Amount ($)',
      value: 'Value',
