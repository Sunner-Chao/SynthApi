export default {
    settings: {
      ...
      payment: {
        ...
        field_alipayEnvironmentHint: 'Must match the environment of the App ID, application private key, and Alipay public key. Sandbox is for testing only.',
