export default {
  ...
  version: {
    ...
    updating: 'Updating...',
    sourceSyncRunning: 'Synchronizing official source',
    sourceSyncTarget: 'Preparing {version}',
    sourceSyncTimeout: 'The update is still running. Refresh to check its status.',
