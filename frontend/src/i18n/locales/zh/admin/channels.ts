export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        provider: '平台',
        probeMode: '检测方式',
        probeModeModelRequest: '模型请求',
        probeModeModelRequestHint: '发送带鉴权的轻量 challenge 请求，验证模型实际可用性。',
        probeModeConnectivityOnly: '仅连通性',
        probeModeConnectivityOnlyHint: '仅对上游域名发送不带密钥的 HEAD 请求，不调用模型接口。',
        apiMode: 'OpenAI 协议',
