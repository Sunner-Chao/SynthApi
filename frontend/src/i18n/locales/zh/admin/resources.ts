export default {
    ...
    redeem: {
      ...
      consignment: {
        settingsButton: '寄售配置',
        title: '寄售充值配置',
        description: '把生成的兑换码作为卡密库存上传到第三方寄售平台，用户付款后回到 SynthAPI 兑换。',
        enable: '显示用户购买入口',
        enableHint: '启用后，用户兑换页会显示购买充值码按钮。',
        purchaseUrl: '购买商品链接',
        purchaseUrlHint: '填写具体商品链接，例如 https://pay.ldxp.cn/item/xxxxxx 或店铺链接。',
        workflowTitle: '推荐工作流',
        workflowGenerate: '生成与套餐对应的兑换码，并下载 TXT。',
        workflowUpload: '在寄售平台的商品卡密库存中上传 TXT 内容。',
        workflowRedeem: '用户付款收卡后，在 SynthAPI 用户端输入兑换码。',
        openLdxp: '打开链动小铺商户端',
        openCatfk: '打开云猫寄售商户端',
        uploadToLdxp: '打开链动小铺',
        uploadToCatfk: '打开云猫寄售',
        loadFailed: '读取寄售配置失败',
        urlRequired: '启用购买入口时必须填写购买链接',
        saved: '寄售配置已保存',
        saveFailed: '保存寄售配置失败'
      },
      codeType: '类型',
