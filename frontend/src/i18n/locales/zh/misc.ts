export default {
  ...
  version: {
    ...
    updateNow: '立即更新',
    updating: '正在更新...',
    sourceSyncRunning: '正在同步官方源码',
    sourceSyncTarget: '正在准备 {version}',
    sourceSyncTimeout: '更新仍在后台执行，请刷新查看状态',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '欢迎使用 SynthAPI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 SynthAPI AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
