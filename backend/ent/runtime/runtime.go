...
func init() {
	...
	// channelmonitorDescProbeMode is the schema descriptor for probe_mode field.
	channelmonitorDescProbeMode := channelmonitorFields[3].Descriptor()
	// channelmonitor.DefaultProbeMode holds the default value on creation for the probe_mode field.
	channelmonitor.DefaultProbeMode = channelmonitorDescProbeMode.Default.(string)
	// channelmonitor.ProbeModeValidator is a validator for the "probe_mode" field. It is called by the builders before save.
	channelmonitor.ProbeModeValidator = channelmonitorDescProbeMode.Validators[0].(func(string) error)
